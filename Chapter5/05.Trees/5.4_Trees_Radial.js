...
function dataViz(incData) {
    ...
    var linkGenerator = d3.svg.diagonal.radial(); //creates diagonal generator with default settings
    linkGenerator.projection(function (d) {
        return [d.y, d.x / 180 * Math.PI]; //switch x and y to orient the lines horizontally
    });
    ...
    d3.select("svg")
        ...
        .attr("transform", function(d) {
            return "rotate(" + (d.x - 90) + ")translate(" + d.y + ")"; //rotates x Points 90deg
        });
